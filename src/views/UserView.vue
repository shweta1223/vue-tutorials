<template>
  <div>
    <div>
      ...
      <div v-bind:class="isCard && 'card'" v-for="user in users" :key="user.id">9
        ...
        <p><span class="title"> 
          Phone -- </span>{{ user.phone }}
        </p>
        <p><span class="title">
          Website -- </span> {{ user.website }}
        </p>
         <p><span class="title">
          Company --</span>  {{ user.company.name }}
        </p>
         <p><span class="title">
          Address --</span>  {{ user.address.city }}
        </p>
        </div>      
        <!-- <router-link :to="`/user/${user.id}`">Article</router-link> -->
